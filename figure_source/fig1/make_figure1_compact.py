"""Create a compact Bioinformatics-ready VALID-OT framework schematic."""
...
def draw_panel_c(ax):
    ...
    rounded(ax, 0.075, 0.115, 0.850, 0.205, BOUNDARY_PALE, BOUNDARY, lw=0.8, radius=0.018)
...
def main():
    ...
    stem = OUT / "fig1_audit_design_compact"
    ...
    try:
        ...
        fig.savefig(OUT / "fig1_audit_design_compact_revised.pdf", bbox_inches="tight", facecolor=PAPER)
    plt.close(fig)
